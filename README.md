...
js/board-data.js         → catálogo de eventos + gerador do tabuleiro de 100 casas
...
- **Ajustar eventos/pegadinhas**: edite o array `EVENTS` em
  `js/board-data.js`. A quantidade de casas especiais (30–40) e as
  regras de distribuição estão em `generateBoard()`.
